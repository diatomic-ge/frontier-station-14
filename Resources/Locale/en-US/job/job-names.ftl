job-name-warden = Warrant Officer
job-name-security = Minuteman
job-name-cadet = Ensign
job-name-hos = Lieutenant Commander
job-name-detective = Military Policeman
job-name-brigmedic = Trauma Medic
...
job-name-hop = General Secretary
job-name-captain = Captain
job-name-serviceworker = Service Worker
job-name-centcomoff = Union Representative
